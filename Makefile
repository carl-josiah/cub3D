...
#    Updated: 2026/05/12 00:38:03 by ccastro          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXECUTE_SRCS			:= execute.c hooks.c mlx.c movement.c render.c
CLEANUP_SRCS			:= parse_errors.c exit_error.c free.c cleanup.c
